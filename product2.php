...
if($value1 == 'ASC')
{
$query = "SELECT * FROM products ORDER BY `products`.`price` ASC  ";
}
else if($value1 == 'DESC'){
    $query = "SELECT * FROM products ORDER BY `products`.`price` DESC ";
}
else if($value1 == 'Name'){
    $query = "SELECT * FROM products ORDER BY `products`.`title` ";

}
else if($value1 == 'Quantity'){
    $query = "SELECT * FROM products ORDER BY `products`.`qty` DESC ";
}
else{
