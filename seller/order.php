        ...
        <div class="container">
            <table class="table container">
                ...
                <tbody>
                    ...
                    <?php
                    $query = 'SELECT orders.id, orders.order_date, orders.product_id, orders.status, orders.user_id, orders.order_amount, products.title, products.image, users.first_name, users.last_name, products.seller_id FROM `orders`, `products`, `users` where orders.product_id=products.id  and products.seller_id="' . $seller_id.'" and orders.user_id=users.id order by id';
