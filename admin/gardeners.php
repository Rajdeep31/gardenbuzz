...
<div class="mainContainer">
    ...
    <div class="allContainer">
        <div class="container jumbotron jumbotron-fluid col-md-6 bg-light my-4 p-4 text-center">
            <div class="container">
                <h1 class="display-4">All Gardener</h1>
            </div>
        </div>
            ...
            <table class="table container">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) { 
                        ...
                        echo "<td>" . $row['experi_year'] . "</td>";
                        echo "<td>" . $row['experties'] . "</td>";
                        echo "<td>" . $row['location'] . "</td>";
                        echo "<td>" . $row['price'] . "</td>";
                        echo "<td>
                                <a href='scripts/delete_script_gardener.php?id={$row['id']}'><button type='button' class='btn btn-danger'>Delete</button></a>
                            </td></tr>";
                    }
