        ...
        <form class="row contact_form" action="confirmation.php" method="post" novalidate="novalidate">
          <div class="col-lg-8">
            ...
            <div class="col-md-4 form-group p_star">
              <input type="text" class="form-control" id="first" name="name1" placeholder="First name"/>
            ...
            <div class="col-md-4 form-group p_star">
              <input type="text" class="form-control" id="email" name="mail" placeholder="Email Address" />
