      ...
      <div class="col-lg-12">
        <div class="order_details_iner">
          ...
          <table class="table table-borderless">
            ...
            <tbody>
              <?php
              $allOrders = "SELECT first_name, last_name, mobile, email from users where id='$user_id'";
          ...
          <form class="row tracking_form" action="scripts/updateprofile.php" method="post" novalidate="novalidate">
              <div class="col-md-12 form-group">
                <!-- <label for="Experties">Experties</label> -->
                    <select id="Experties" name="Experties" class="form-control my-2">
                        <option selected>Update Profile</option>
              ...
              <div class="col-md-12 form-group">
                <input type="text" class="form-control" id="updatetext" name="updatetext" placeholder="Enter Here..">
              </div>
              <div class="col-md-12 form-group">
