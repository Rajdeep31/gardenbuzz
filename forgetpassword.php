            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="login_part_text text-center">
                        ...
                        <h2 style="color: black;">Back to Login?<h2>
                        <a href="register.php" class="btn_3">Login</a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>
                                Welcome to Our Store ! <br /> Forget your password here
                            </h3>
                            <form class="row contact_form" action="scripts/forgetpassword.php" method="post">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" required id="password" name="password" value="" placeholder="New Password" />
                                </div>
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="submit" class="btn_3">
											Forget
										</button>
                                    <a class="lost_pass" href="login.php">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
