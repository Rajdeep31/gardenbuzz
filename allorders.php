        ...
        <div class="order_details_iner">
          ...
          <table class="table table-borderless">
            ...
            <tbody>
              ...
              <?php
              $allOrdersgardener = "SELECT orders.id, orders.order_date ,gardener.last_name, orders.product_qty, orders.order_amount, orders.status from orders, gardener where user_id='$user_id' and orders.product_id=gardener.id";
